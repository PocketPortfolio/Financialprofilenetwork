...
// Risk sitemaps retired (CMD growth stack Sep 2026): ~15K track-*-risk URLs contradicted de-farm.
// Files remain for history; excluded from index and static build output.
