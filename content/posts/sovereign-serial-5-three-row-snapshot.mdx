---
title: 'The 3-Row Snapshot: Privacy-Preserving Inference'
date: '2026-02-25'
description: >-
  We send only headers and the first three sample rows to the LLM—enough to disambiguate columns without exposing the user's full trade history.
tags:
  - privacy
  - llm
  - csv
