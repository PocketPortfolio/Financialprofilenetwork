---
title: 'Beyond Finance: Use Cases for Client-Side ETL'
date: '2026-03-18'
description: >-
  The "headers + sample → mapping → parse" pattern is generic. Brokers, banks, crypto, tax tools—and time tracking, inventory, CRM exports.
tags:
  - etl
  - csv
  - use-cases
...
image: /book-assets/assets/chapter-headers/chapter-10-header.svg
pillar: technical
