---
title: 'Why We Bet on CSV over APIs'
date: '2026-02-13'
description: >-
  Broker APIs are permissioned, versioned, and revocable. We chose CSV as the sovereign, user-owned format—and built a pipeline that makes it first-class.
tags:
  - csv
  - apis
  - plaid
...
image: /book-assets/assets/chapter-headers/chapter-02-header.svg
pillar: technical
