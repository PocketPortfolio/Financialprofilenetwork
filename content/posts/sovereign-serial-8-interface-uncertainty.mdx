---
title: 'The Interface of Uncertainty: Designing Human-in-the-Loop'
date: '2026-03-06'
description: >-
  When confidence is below 0.9, we show the mapping UI—not a silent guess. Designing for REQUIRES_MAPPING and user confirmation.
tags:
  - ui
  - human-in-the-loop
  - csv
...
image: /book-assets/assets/chapter-headers/chapter-07-header.svg
pillar: technical
