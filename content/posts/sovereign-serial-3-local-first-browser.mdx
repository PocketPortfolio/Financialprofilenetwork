---
title: 'Building Local-First: The Browser as the Server'
date: '2026-02-18'
description: >-
  Heavy work runs in the client. File reading, CSV parsing, heuristic mapping—and only when needed, a tiny payload to an LLM for column mapping. The full CSV never leaves the browser.
tags:
  - local-first
  - browser
  - csv
...
image: /book-assets/assets/chapter-headers/chapter-03-header.svg
pillar: technical
...
![Local-first flow: CSV file to normalized trades; browser does the work.](/book-assets/figures/figure-02-local-first-flow.svg)
