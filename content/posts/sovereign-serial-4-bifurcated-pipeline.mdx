---
title: 'The Bifurcated Pipeline: Heuristics + LLMs'
date: '2026-02-20'
description: >-
  Heuristic runs first; LLM runs only when confidence is below 0.9. Mapping is probabilistic; parsing is deterministic. Here's how the two paths work together.
tags:
  - llm
  - schema-inference
  - heuristics
...
image: /book-assets/assets/chapter-headers/chapter-04-header.svg
pillar: technical
...
![LLM-assisted ingestion lifecycle: user, browser, heuristic, API, mapping UI.](/book-assets/figures/figure-03-llm-lifecycle.svg)
