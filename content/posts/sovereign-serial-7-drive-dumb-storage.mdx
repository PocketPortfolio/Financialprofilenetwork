---
title: 'Google Drive as Dumb Storage'
date: '2026-03-04'
description: >-
  Drive stores one JSON file. No backend logic, no schema interpretation—the client owns sync and conflict semantics. Here's the model.
tags:
  - google-drive
  - sovereign-sync
  - local-first
...
image: /book-assets/assets/chapter-headers/chapter-06-header.svg
pillar: technical
...
![Local device ↔ Drive ↔ restore. Client exports/imports; Drive stores one file.](/book-assets/figures/figure-04-drive-sync.svg)
