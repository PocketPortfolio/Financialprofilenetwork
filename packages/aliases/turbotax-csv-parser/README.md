...
[![NPM Downloads](https://img.shields.io/npm/dw/@pocket-portfolio/turbotax-csv-parser?style=for-the-badge&color=orange)](https://www.npmjs.com/package/@pocket-portfolio/turbotax-csv-parser)
...
```bash
npm install @pocket-portfolio/turbotax-csv-parser
```
