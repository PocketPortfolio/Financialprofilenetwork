...
[![NPM Downloads](https://img.shields.io/npm/dw/@pocket-portfolio/fidelity-csv-export?style=for-the-badge&color=orange)](https://www.npmjs.com/package/@pocket-portfolio/fidelity-csv-export)
...
```bash
npm install @pocket-portfolio/fidelity-csv-export
```
