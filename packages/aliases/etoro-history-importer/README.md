...
[![NPM Downloads](https://img.shields.io/npm/dw/@pocket-portfolio/etoro-history-importer?style=for-the-badge&color=orange)](https://www.npmjs.com/package/@pocket-portfolio/etoro-history-importer)
...
```bash
npm install @pocket-portfolio/etoro-history-importer
```
