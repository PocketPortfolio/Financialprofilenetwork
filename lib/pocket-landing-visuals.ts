...
export const POCKET_LANDING_VISUALS: Record<PocketLandingVisualId, PocketLandingVisualMeta> = {
  portalTerminal: {
    ...
    alt: 'Amber data-matrix terminal render for the Pocket Portfolio app',
    overlay: 'portal',
    portalKey: 'terminal',
    aspectRatio: '4 / 3',
  ...
  portalStorage: {
    ...
    alt: 'Glass sovereign vault render for user-owned sync and export',
    overlay: 'portal',
    portalKey: 'storage',
    aspectRatio: '4 / 3',
  ...
  portalFounders: {
    ...
    alt: 'Command insignia render for Founders Club access',
    overlay: 'portal',
    portalKey: 'founders',
    aspectRatio: '4 / 3',
