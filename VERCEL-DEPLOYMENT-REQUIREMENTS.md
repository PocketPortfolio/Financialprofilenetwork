...
### 4. Pocket Analyst (Ask AI)
- [ ] Dashboard: Ask AI FAB opens modal; send a message → streamed reply
- [ ] Free user: quota badge shows X/20; 429 and upgrade modal after limit
- [ ] Landing: “Your Personal Quantitative Analyst” section shows video (if `NEXT_PUBLIC_POCKET_ANALYST_VIDEO_URL` set) and “Try Ask AI” / “Watch Demo” work
- [ ] Admin: `/admin/analytics` shows “Pocket Analyst (Ask AI)” section after some usage
