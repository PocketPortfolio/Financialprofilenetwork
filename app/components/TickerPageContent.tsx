          ...
          {metadata.faqs.length > 0 && (
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {metadata.faqs.map((faq: any, index: number) => (
                  <div 
                    key={index} 
                    style={{
                      borderBottom: index < metadata.faqs.length - 1 ? '1px solid var(--border-subtle)' : 'none',
                      paddingBottom: index < metadata.faqs.length - 1 ? '16px' : 0
                    }}
                  >
                    <h3 style={{
                      fontSize: '18px',
