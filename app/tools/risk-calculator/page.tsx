...
export default function RiskCalculatorPage() {
  ...
  const analyzeRisk = async () => {
    ...
    try {
      ...
      // Calculate Average Beta (Equal Weight for this free tool)
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{
            ...
            Enter your top 3 stock tickers to check your volatility exposure.
          </p>
        </div>
        ...
        {result && (
          <div style={{
            ...
            {/* Individual Ticker Breakdown (Optional - shows value) */}
