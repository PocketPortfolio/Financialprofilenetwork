...
export default function DoraEuAiActWealthPage() {
  return (
    <SovereignPillarArticle
      ...
      body={[
        'DORA pushes ICT risk, third-party concentration, and incident readiness into the board conversation. For portfolio platforms, the quiet killer is unnecessary data gravity: every vendor-hosted ledger copy expands the blast radius of an ICT event.',
